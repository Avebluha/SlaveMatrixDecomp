...
namespace SlaveMatrix
{
    public class バイブ_デンマ : Ele //baibu_denma
    {
    	...
    	public バイブ_デンマ(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, バイブ_デンマD e)
    	{
    		...
    		Intensity = e.濃度;
    		X0Y0_ユニット_ユニット.SetBasePointBase(X0Y0_ユニット_ユニット.ToLocal(X0Y0_ヘッド.ToGlobal(X0Y0_ヘッド.GetJP()[1].Joint)));
    		X0Y1_ユニット_ユニット.SetBasePointBase(X0Y1_ユニット_ユニット.ToLocal(X0Y1_ヘッド.ToGlobal(X0Y1_ヘッド.GetJP()[1].Joint)));
    		X0Y2_ユニット_ユニット.SetBasePointBase(X0Y2_ユニット_ユニット.ToLocal(X0Y2_ヘッド.ToGlobal(X0Y2_ヘッド.GetJP()[1].Joint)));
    		X0Y3_ユニット_ユニット.SetBasePointBase(X0Y3_ユニット_ユニット.ToLocal(X0Y3_ヘッド.ToGlobal(X0Y3_ヘッド.GetJP()[1].Joint)));
    		X0Y4_ユニット_ユニット.SetBasePointBase(X0Y4_ユニット_ユニット.ToLocal(X0Y4_ヘッド.ToGlobal(X0Y4_ヘッド.GetJP()[1].Joint)));
    		尺度B *= 1.07;
    		尺度B = 1.08;
    		Body.JoinPAall();
    	}
