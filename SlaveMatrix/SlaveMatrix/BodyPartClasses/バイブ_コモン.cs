...
namespace SlaveMatrix
{
    public class バイブ_コモン : Element
    {
    	...
    	public バイブ_コモン(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, バイブ_コモンD e)
    	{
    		...
    		Intensity = e.濃度;
    		X0Y0_ユニット_ユニット.SetBasePointBase(X0Y0_ユニット_ユニット.ToLocal(X0Y0_ヘッド.ToGlobal(X0Y0_ヘッド.GetJP()[12].Joint)));
    		X0Y1_ユニット_ユニット.SetBasePointBase(X0Y1_ユニット_ユニット.ToLocal(X0Y1_ヘッド.ToGlobal(X0Y1_ヘッド.GetJP()[12].Joint)));
    		X0Y2_ユニット_ユニット.SetBasePointBase(X0Y2_ユニット_ユニット.ToLocal(X0Y2_ヘッド.ToGlobal(X0Y2_ヘッド.GetJP()[9].Joint)));
    		X0Y3_ユニット_ユニット.SetBasePointBase(X0Y3_ユニット_ユニット.ToLocal(X0Y3_ヘッド.ToGlobal(X0Y3_ヘッド.GetJP()[6].Joint)));
