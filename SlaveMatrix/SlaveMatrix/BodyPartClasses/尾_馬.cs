...
namespace SlaveMatrix
{
    public class 尾_馬 : 尾
    {
    	...
    	public override void SetAngle0()
    	{
    		...
    		X0Y0_中央_尾0.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_中央_尾1.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_中央_尾2.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_中央_尾3.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_中央_尾4.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_中央_尾5.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_中央_尾6.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾0.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾1.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾2.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾3.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾4.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾5.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左2_尾6.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾0.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾1.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾2.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾3.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾4.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾5.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_左1_尾6.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾0.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾1.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾2.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾3.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾4.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾5.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右2_尾6.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾0.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾1.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾2.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾3.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾4.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾5.SetAngleBase(maxAngle.GetRanAngle());
    		X0Y0_右1_尾6.SetAngleBase(maxAngle.GetRanAngle());
    		Body.JoinPAall();
    	}
