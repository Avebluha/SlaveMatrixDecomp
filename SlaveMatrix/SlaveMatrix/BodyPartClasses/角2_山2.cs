...
namespace SlaveMatrix
{
    public class 角2_山2 : 角2
    {
    	...
    	public ShapePart X0Y0_凸8;

    	public ShapePart X0Y0_凸9;
    	...
    	public 角2_山2(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, 角2_山2D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant(GlobalState.肢左["角"][1]);
    		...
    		X0Y0_凸8 = partGroup["凸8"].ToPar();
    		X0Y0_凸9 = partGroup["凸9"].ToPar();
    		partGroup = Body[0][1];
    	...
    	public override void SetAngle0()
    	{
    		...
    		X0Y0_根.SetAngleBase(num * -49.0000000000001);
    		X0Y1_根.SetAngleBase(num * -49.0000000000001);
    		Body.JoinPAall();
    	}
    	...
    	private void 配色N0(BodyColorSet 体配色)
    	{
    		...
    		凸8CD = new ColorD(ref ColorHelper.Black, ref 体配色.角1O);
    		凸9CD = new ColorD(ref ColorHelper.Black, ref 体配色.角1O);
    	...
    	private void 配色T0(BodyColorSet 体配色)
    	{
    		...
    		凸8CD = new ColorD(ref ColorHelper.Black, ref 体配色.刺青O);
    		凸9CD = new ColorD(ref ColorHelper.Black, ref 体配色.刺青O);
    		折線CD = new ColorD(ref ColorHelper.Black, ref Color2.Empty);
    	}
