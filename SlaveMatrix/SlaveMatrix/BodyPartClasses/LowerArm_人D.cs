...
namespace SlaveMatrix
{
    ...
    public class LowerArm_人D : LowerArmD
    {
    	...
    	public List<ElementData> OuterArm_接続 = new List<ElementData>();

    	public List<ElementData> 虫鎌_接続 = new List<ElementData>();
    	...
    	public void 外腕接続(ElementData e)
    	{
    		OuterArm_接続.Add(e);
    		e.Par = this;
    	...
    	public void 虫鎌接続(ElementData e)
    	{
    		虫鎌_接続.Add(e);
    		e.Par = this;
