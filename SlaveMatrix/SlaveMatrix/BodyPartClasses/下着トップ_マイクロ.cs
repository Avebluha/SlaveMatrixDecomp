    ...
    public class 下着トップ_マイクロ : 下着トップ
    {
    	...
    	public double バスト
    	{
    		set
    		{
    			...
    			X0Y0_カップ左_カップ.SetSizeBase(sizeBase);
    			...
    			X0Y0_カップ右_カップ.SetSizeBase(sizeBase);
    			...
    			X0Y0_カップ左_カップ.SetSizeYBase(sizeBase);
    			...
    			X0Y0_カップ右_カップ.SetSizeYBase(sizeBase);
    	...
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant(GlobalState.胴体["下着トップ"][2]);
