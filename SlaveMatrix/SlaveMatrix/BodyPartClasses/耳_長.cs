...
namespace SlaveMatrix
{
    public class 耳_長 : 耳
    {
    	...
    	public 耳_長(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, 耳_長D e)
    	{
    		ThisType = GetType();
    		Body = new VariantGrid();
    		Body.Tag = "長";
    		Body.Add(new MorphVariant(GlobalState.肢左["耳"][4]));
    		Body.Add(new MorphVariant(GlobalState.肢左["耳"][5]));
    	...
    	public override void SetAngle0()
    	{
    		...
    		X0Y0_耳.SetAngleBase(num * -344.0);
    		X0Y1_耳.SetAngleBase(num * -351.0);
    		X0Y2_耳.SetAngleBase(num * 0.0);
    		X1Y0_耳.SetAngleBase(num * -344.0);
    		X1Y1_耳.SetAngleBase(num * -351.0);
